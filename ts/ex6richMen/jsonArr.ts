...
//   country: string;
//   image: string;
//   constructor(name: string, worth: string, birth_year: string, source: string, country: string, image: string) {
//     this.name = name;
//     this.worth = worth;
...
// export const ric_men_arr: Array<RichMan> = [];
// json_ar.forEach(man => {
//   ric_men_arr.push(new RichMan(man.name, man.worth, man.birth_year, man.source, man.country, man.image))
// })
