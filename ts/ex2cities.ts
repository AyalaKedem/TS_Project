...
const user_input = document.getElementById("user_input") as HTMLInputElement;
const add_btn = document.getElementById("add_btn") as HTMLButtonElement;
const list_cities_btn = document.getElementById("list_cities_btn") as HTMLButtonElement;
const list_box = document.getElementById("list_box") as HTMLUListElement;
const auto_list = document.querySelector(".auto_list") as HTMLUListElement;
const box = document.getElementById("box") as HTMLDivElement;
const city_box = document.getElementById("city_box") as HTMLDivElement;
const for_X = document.getElementById("for_X") as HTMLDivElement;
...
list_cities_btn.addEventListener("click", () => {
  ...
  const arr_from_localStorage: Array<string> = JSON.parse(str_from_localStorage);
...
function focusCity(item: string) {
